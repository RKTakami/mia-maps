...
public final class MapNative {
    ...
    // Cascade staging. Shell meshes live in persistent SLOTS (0 = innermost): re-mesh only the shells
    // that actually moved, then commit the shell count. Only the commit is visible to the render
